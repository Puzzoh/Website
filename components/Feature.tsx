...
export const FeatureContainer: React.FC<{ children: React.ReactNode }> = ({
  children,
}) => (
...
export const FeatureBackground: React.FC = () => (
...
export const FeatureLeft: React.FC<{
  ...
  return (
    <div
      className="flex flex-col items-center justify-center text-3xl lg:text-3xl h-[30vh] lg:h-auto bg-first"
      style={{
